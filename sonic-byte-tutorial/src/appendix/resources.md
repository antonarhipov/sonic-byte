...
### Official Resources
- [Sonic Pi Website](https://sonic-pi.net/) — Download and documentation
- [Sonic Pi Tutorial](https://sonic-pi.net/tutorial) — Built-in tutorial
- [Sonic Pi Reference](https://sonic-pi.net/docs) — Full documentation

### Community
- [Sonic Pi Forum](https://in-thread.sonic-pi.net/) — Community discussions
- [Sonic Pi GitHub](https://github.com/sonic-pi-net/sonic-pi) — Source code, issues

## Music Theory

### For Electronic Producers
- [Learning Music (Ableton)](https://learningmusic.ableton.com/) — Interactive basics
- [Music Theory for Electronic Producers](https://www.edmprod.com/music-theory/) — Genre-focused

### Synthesis
- [Syntorial](https://www.syntorial.com/) — Learn synthesis by ear
- [Sound on Sound Synth Secrets](https://www.soundonsound.com/techniques/synth-secrets) — Deep synthesis theory
...
- [Algorave](https://algorave.com/) — Algorithmic dance music
